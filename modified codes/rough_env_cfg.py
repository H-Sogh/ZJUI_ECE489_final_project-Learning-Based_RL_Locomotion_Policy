...
class UnitreeGo1RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    def __post_init__(self):
        ...
        # # added
        # self.rewards.flat_orientation_l2.weight = -2.5  # Penalize roll/pitch deviation
...
class UnitreeGo1RoughEnvCfg_PLAY(UnitreeGo1RoughEnvCfg):
    def __post_init__(self):
        ...
        self.events.push_robot_eval = EventTerm(
            func=mdp.apply_external_force_torque,
            mode="interval",
            interval_range_s=(10.0, 10.0),  # Trigger every 10 seconds of sim time (~2000 steps @ 0.005s dt)
            params={
                "asset_cfg": SceneEntityCfg("robot", body_names="trunk"),  # Use "trunk", not "base" for Go1
                "force_range": {"x": (0.0, 0.0), "y": (30.0, 50.0), "z": (0.0, 0.0)},
